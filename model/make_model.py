...
from model.backbones.vit_pytorch import TransReID, deit_tiny_patch16_224_TransReID, vit_base_patch32_224_TransReID, vit_large_patch16_224_TransReID, vit_base_patch16_224_mix_vit
import torch
...
def make_model(cfg, modelname, num_class, num_class_domain_wise=None):
    if modelname == 'vit':
        ...
        model = build_mix_vit(num_class, cfg, __factory_T_type, num_class_domain_wise)
